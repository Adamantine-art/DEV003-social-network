...
const reviews = () => {
  ...
  const printReviews = (commentField, commentId) => {
    ...
    <div class="edit-delete-icons">
      <a class="edit-icon"><img src="img/edit-pencil.png"  alt="edit"></a>
      <a class="delete-icon">
        <img src="img/trash.png"  alt="delete" data-id="${commentId}" />
      </a>
    </div>
  </div>`;
...
const deleteReview = (documentId) => Gl(Aa(db, "reviews", documentId));
const signUp = (props = {}) => {
